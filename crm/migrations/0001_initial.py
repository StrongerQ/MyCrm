# Generated by Django 2.0.1 on 2018-02-05 08:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_type', models.SmallIntegerField(choices=[(0, '周末面授'), (1, '脱产面授'), (2, '网络')], verbose_name='班级类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('referral_from', models.CharField(blank=True, max_length=64, null=True, verbose_name='介绍人')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(choices=[(100, 'A+'), (90, 'A'), (85, 'B+'), (80, 'B'), (75, 'B-'), (70, 'C+'), (60, 'C'), (40, 'C-'), (0, 'N/A'), (-50, 'D'), (-100, 'COPY')])),
        ...
        migrations.AddField(
            model_name='payment',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.Course', verbose_name='报名课程'),
        ),
        migrations.AddField(
            model_name='payment',
            name='customer',
